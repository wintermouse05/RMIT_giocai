...
const phoneGames = [
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "This is the ATO. We detected irregularities in your tax return.",
      },
      { type: "outgoing", text: "What do I need to do?" },
      {
        type: "incoming",
        text: "You must pay today to avoid legal action. Purchase gift cards and read the codes to me.",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "Hello, Australia Post here — your parcel is ready for pickup at the City branch.",
      },
      { type: "outgoing", text: "Great, what ID do I need?" },
      {
        type: "incoming",
        text: "Just bring photo ID. No payment is required by phone.",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "NBN Co here — your router is infected and attacking our network.",
      },
      { type: "outgoing", text: "That sounds serious. How do I fix it?" },
      {
        type: "incoming",
        text: "Install a remote access tool so we can repair it, then pay a service fee today.",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "We’ve blocked a suspicious transfer. Confirm your card and one-time code now.",
      },
      { type: "outgoing", text: "I can log into my banking app to check." },
      {
        type: "incoming",
        text: "No time. Read the one-time code from your SMS quickly!",
      },
      {
        type: "outgoing",
        text: "I will call the bank on the number on my card.",
      },
    ],
    isPhishing: true,
    hints: [
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "Home Affairs — your visa status is non-compliant. Pay a penalty today or face deportation.",
      },
      { type: "outgoing", text: "I’ve never received any notice about this." },
      {
        type: "incoming",
        text: "This is urgent. Transfer funds now to avoid immediate action.",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "Your power will be disconnected today unless you pay now by phone.",
      },
      { type: "outgoing", text: "I’ll check my online account first." },
      {
        type: "incoming",
        text: "No, pay now by card to avoid immediate cutoff.",
      },
  ...
  },
  {
    ...
    callerInfo:
      "Task-based job scam (WhatsApp/Telegram ‘rating tasks’) linked to overseas rings",
    conversation: [
      {
        type: "incoming",
        text: "Easy remote job: complete simple tasks and earn $300/day.",
      },
      { type: "outgoing", text: "What’s required?" },
      {
        type: "incoming",
        text: "First deposit a small amount to ‘activate’ your account — you’ll withdraw more later.",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "This is the AFP. A warrant has been issued in your name.",
      },
      {
        type: "outgoing",
        text: "I’ve received no letters or emails about that.",
      },
      {
        type: "incoming",
        text: "To resolve this, pay a security bond now via bank transfer.",
      },
      {
        type: "outgoing",
        text: "I will verify with the official AFP contact first.",
      },
    ],
    isPhishing: true,
    hints: [
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "Council here — tomorrow’s bin pickup is delayed to Friday due to a truck issue.",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "Tech visit confirmation for Friday 2–4pm — does that still work for you?",
      },
  ...
  },
  {
    ...
    conversation: [
      {
        type: "incoming",
        text: "I found a guaranteed crypto opportunity — we can double your funds in a week.",
      },
      { type: "outgoing", text: "That sounds risky. Is it regulated?" },
      {
        type: "incoming",
        text: "Don’t miss out — transfer now and I’ll guide you step-by-step on WhatsApp.",
      },
...
const phoneLookupDB = {
  "+61 2 8015 4470": {
    ...
    reports: 312,
    anomaly:
      "Clusters of ‘ATO payment’ scripts; short ring/recall cycles; suspected spoofing",
  },
  "+61 3 7000 1245": {
  ...
  "+61 2 8880 9011": {
    ...
    reports: 154,
    anomaly:
      "Remote-access tool referrals; fee collection attempts post ‘router infection’ script",
  },
  "+61 7 3150 7788": {
    ...
    reports: 198,
    anomaly:
      "OTP requests tied to ‘bank fraud’ narrative; multiple bank brands in same session",
  },
  "+61 2 6100 0000": {
  ...
  "+61 412 345 678": {
    ...
    reports: 167,
    anomaly:
      "‘Deposit to activate job account’ pattern; migration to encrypted apps",
  },
  "+61 3 7001 4422": {
  ...
  "+61 4 5556 7788": {
    ...
    reports: 203,
    anomaly:
      "‘Guaranteed returns’ narratives; wallet addresses rotate; off-platform guidance",
  },
};
